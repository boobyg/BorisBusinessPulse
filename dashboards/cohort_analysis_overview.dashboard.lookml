...
- dashboard: cohort_analysis_overview
  ...
  - name: " (2)"
    ...
    body_text: "\n<div style=\"border-bottom: solid 1px #4285F4;\">\n\n<nav style=\"\
      ...
      /dashboards-next/business_pulse::cohort_analysis_overview\">Cohort Analysis</a>\n\n\
      \  <a style=\"padding: 5px 15px; border-bottom: solid 1px #4285F4; float: left;\
      \ line-height: 40px;\" href=\"/dashboards-next/business_pulse::cluster_analysis_overview\"\
      >Cluster Analysis</a>\n\n  <a style=\"padding: 5px 15px; border-bottom: solid\
      \ 1px #4285F4; float: left; line-height: 40px;\" href=\"/dashboards-next/business_pulse::training_evaluation_overview\"\
